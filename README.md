...
**▶ 라이브 데모: https://huggingface.co/spaces/reasonableplan/hyundab-molding-copilot**
— 진짜결함 19개 + held-out 정상 12개를 LOO out-of-sample 파생값으로 재생한다. 검출·기권·근거
인용을 직접 눌러볼 수 있다 (KAMP 원본 데이터·LLM 미포함, 사전계산 방식은 [demo/README.md](demo/README.md)).
